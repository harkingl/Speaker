...
package com.android.speaker.base.component.wheel;
...
import com.android.speaker.base.component.wheel.adapter.AbstractWheelAdapter;
import com.android.speaker.base.component.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.color.transparent;
...
//				getResources().getColor(R.color.transparent),
//				getResources().getColor(R.color.transparent));
		setWheelForeground(R.drawable.wheel_foreground_shape);
		setWheelBackground(android.R.color.transparent);
	}
