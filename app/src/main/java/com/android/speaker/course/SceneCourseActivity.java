...
public class SceneCourseActivity extends BaseActivity implements View.OnClickListener {
    ...
    private SceneCourseAdapter mCourseAdapter;
    ...
    private void initView() {
        setContentView(R.layout.activity_scene_course);

        mBackIv = findViewById(R.id.scene_course_back_iv);
        mParentCategoryGv = findViewById(R.id.parent_course_category_gv);
        mChildCategoryLv = findViewById(R.id.child_course_category_lv);
        mCourseLv = findViewById(R.id.scene_course_lv);
    ...
    private void initData() {
        ...
        mList = new ArrayList<>();
        mCourseAdapter = new SceneCourseAdapter(this, mList);
    ...
    private void loadCourseList(boolean isRefresh) {
        ...
        new GetCourseListBySubRequest(this, mPageNo, PAGE_SIZE, mCurrSubItem.id).schedule(false, new RequestListener<PagedListEntity<CourseItem>>() {
            @Override
            public void onSuccess(PagedListEntity<CourseItem> result) {
    ...
    public void onClick(View view) {
        int id = view.getId();
        switch(id) {
            case R.id.scene_course_back_iv:
                finish();
                break;
        }
    }
