package com.android.speaker.course.wave;
...
public class WaveLineView extends RenderView {
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        lineColor = t.getColor(R.styleable.WaveLineView_wlvLineColor, getResources().getColor(R.color.common_green_color));
