 ...
 * 热门单集
 */
public class GetHotBlogListRequest extends BaseRequest<List<BlogItem>> {
    private int pageNum;
    private int pageSize;
    public GetHotBlogListRequest(Context context, int pageNum, int pageSize) {
        super(context);
    ...
    protected String url() {
        return UrlManager.GET_HOT_BLOG_LIST;
    }
