...
public class BlogRecordListFragment extends BaseFragment {
    private static final int PAGE_SIZE = 20;
    private PagedItemListView mListView;
    private ImageView mEmptyIv;
    private BlogRecordListAdapter mAdapter;
    ...
    private void initData() {
        mList = new ArrayList<>();
        mAdapter = new BlogRecordListAdapter(getActivity(), mList);
    ...
    private void loadData() {
        new GetBlogRecordListRequest(getActivity(), mPageNo, PAGE_SIZE).schedule(false, new RequestListener<List<RecordInfo>>() {
            @Override
