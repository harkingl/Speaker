 ...
 * 获取博客学习记录列表
 */
public class GetBlogRecordListRequest extends BaseRequest<List<RecordInfo>> {
    private int pageNum;
    private int pageSize;
    public GetBlogRecordListRequest(Context context, int pageNum, int pageSize) {
        super(context);
    ...
    protected String url() {
        return UrlManager.GET_BLOG_RECORD_LIST;
    }
